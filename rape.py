#!/usr/bin/env python3
"""
Telegram Card Checker Bot – All-in-one (PayPal, Stripe, BIN, xForce)
"""
...
# ======================================================================
# Auto‑write replit.nix once
# ======================================================================
def write_replit_nix():
    nix_path = "replit.nix"
...
# ======================================================================
# Bright Data CAPTCHA Solver (public key from user)
# ======================================================================
...
# ======================================================================
# Proxy Manager (for Stripe & PayPal)
# ======================================================================
class ProxyManager:
    _proxies: List[str] = []
    _index = 0
...
# ======================================================================
# Stripe Authorizer (with proxy rotation)
# ======================================================================
STRIPE_KEYS = [
...
# ======================================================================
# Enhanced PayPal Charger (with proxy and random donor)
# ======================================================================
...
# ======================================================================
# xForce automation with Bright Data CAPTCHA solver and interstitial click
# ======================================================================
def xlog(tag, msg):
